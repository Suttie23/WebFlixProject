...
if (mysqli_num_rows($r) > 0) {
  ...
  while ($row = mysqli_fetch_array($r, MYSQLI_ASSOC)) {
    echo '
        <h1 class="mb-3 text-white text-center"><strong>'  . $row['tv_title'] . '</strong></h1>
        <div class="container">
        <hr class="featurette-divider text-white">
         ...
         <h2 style="padding-bottom:20px;">Genre: '  . $row['genre'] . ' </h2>
          <h2 style="padding-bottom:50px;">Synopsis: '  . $row['tv_desc'] . '</h2>
        </div>
        </div>
