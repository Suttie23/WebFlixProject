...
<h2 class ="text-center" style="margin-top: 25px; margin-bottom: 25px;">Website Terms of Use</h2>

<p class = "text-center" style="margin-top: 25px; margin-bottom: 25px;">Version 1.0</p>

<p>The WebFlix website located at http://46.101.32.209 is a copyrighted work belonging to WebFlix. Certain features of the Site may be subject to additional guidelines, terms, or rules, which will be posted on the Site in connection with such features.</p>
...
<h2 class = "text-center" style="margin-top: 25px; margin-bottom: 25px;">Access to the Site</h2>
...
<h2 class = "text-center" style="margin-top: 25px; margin-bottom: 25px;">Third-Party Links & Ads; Other Users</h2>
...
<h2 class = "text-center" style="margin-top: 25px; margin-bottom: 25px;">Disclaimers</h2>
...
<h2 class = "text-center" style="margin-top: 25px; margin-bottom: 25px;">Limitation on Liability</h2>
...
<h2 class = "text-center" style="margin-top: 25px; margin-bottom: 25px;">Copyright Policy.</h2>
...
<h2 class = "text-center" style="margin-top: 25px; margin-bottom: 25px;">General</h2>
...
<p><strong>Notice Requirement and Informal Dispute Resolution.</strong> Before either party may seek arbitration, the party must first send to the other party a written Notice of Dispute describing the nature and basis of the claim or dispute, and the requested relief.  A Notice to the Company should be sent to: 456 AeMysterious Place. After the Notice is received, you and the Company may attempt to resolve the claim or dispute informally.  If you and the Company do not resolve the claim or dispute within thirty (30) days after the Notice is received, either party may begin an arbitration proceeding.  The amount of any settlement offer made by any party may not be disclosed to the arbitrator until after the arbitrator has determined the amount of the award to which either party is entitled.</p>
...
<h2 class = "text-center" style="margin-top: 25px; margin-bottom: 25px;">Contact Information </h2>

<p class = "text-center">Address: 456 AeMysterious Place</p>
<p class = "text-center">Email: WebFlix@notarealemail.com</p>
</div>
