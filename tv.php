...
<div id="tvsection">
    <h1 class="mb-3 text-white text-center "><strong>TV</strong></h1>
    ...
    if (mysqli_num_rows($n) > 0) {
        while ($row = mysqli_fetch_array($n, MYSQLI_ASSOC)) {
            ...
            $r = mysqli_query($link, "SELECT * FROM tv WHERE genre = '{$row['genre_name']}'");
                    ...
                    <div class="responsive-slick">
                        ...
                        ?>
                            <div class="slider-image">
                                <a href="tvpage.php?id=<?php echo $mov['tv_id']; ?>">
                                    <img class="slider-img" style="max-width: 300px; max-height: 175px;" src="<?php echo "{$mov['tv_img']}"; ?>" class="slider-img" alt="<?php echo "{$mov['tv_title']}"; ?>">
                                    <div class="info">
